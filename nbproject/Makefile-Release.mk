...
${OBJECTDIR}/src/http_auth.o: src/http_auth.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/http_auth.o src/http_auth.c

${OBJECTDIR}/src/http_client.o: src/http_client.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/http_client.o src/http_client.c

${OBJECTDIR}/src/options.o: src/options.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/options.o src/options.c

${OBJECTDIR}/src/pam_account.o: src/pam_account.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_account.o src/pam_account.c

${OBJECTDIR}/src/pam_auth.o: src/pam_auth.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_auth.o src/pam_auth.c

${OBJECTDIR}/src/pam_password.o: src/pam_password.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_password.o src/pam_password.c

${OBJECTDIR}/src/pam_session.o: src/pam_session.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_session.o src/pam_session.c
...
${TESTDIR}/tests/gtest_main.o: tests/gtest_main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iexternal/googletest/googletest/include -I. -Iexternal/httpmockserver/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/gtest_main.o tests/gtest_main.cpp


${TESTDIR}/tests/http_auth_test.o: tests/http_auth_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iexternal/googletest/googletest/include -I. -Iexternal/httpmockserver/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/http_auth_test.o tests/http_auth_test.cpp


${TESTDIR}/tests/http_client_test.o: tests/http_client_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iexternal/googletest/googletest/include -I. -Iexternal/httpmockserver/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/http_client_test.o tests/http_client_test.cpp


${TESTDIR}/tests/options_test.o: tests/options_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iexternal/googletest/googletest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/options_test.o tests/options_test.cpp
...
${OBJECTDIR}/src/http_auth_nomain.o: ${OBJECTDIR}/src/http_auth.o src/http_auth.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/http_auth_nomain.o src/http_auth.c;\
	else  \
...
${OBJECTDIR}/src/http_client_nomain.o: ${OBJECTDIR}/src/http_client.o src/http_client.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/http_client_nomain.o src/http_client.c;\
	else  \
...
${OBJECTDIR}/src/options_nomain.o: ${OBJECTDIR}/src/options.o src/options.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/options_nomain.o src/options.c;\
	else  \
...
${OBJECTDIR}/src/pam_account_nomain.o: ${OBJECTDIR}/src/pam_account.o src/pam_account.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_account_nomain.o src/pam_account.c;\
	else  \
...
${OBJECTDIR}/src/pam_auth_nomain.o: ${OBJECTDIR}/src/pam_auth.o src/pam_auth.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_auth_nomain.o src/pam_auth.c;\
	else  \
...
${OBJECTDIR}/src/pam_password_nomain.o: ${OBJECTDIR}/src/pam_password.o src/pam_password.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_password_nomain.o src/pam_password.c;\
	else  \
...
${OBJECTDIR}/src/pam_session_nomain.o: ${OBJECTDIR}/src/pam_session.o src/pam_session.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pam_session_nomain.o src/pam_session.c;\
	else  \
